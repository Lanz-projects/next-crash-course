...
// Use async middleware without `next` and throw errors so TypeScript
// and mongoose handle promise rejections correctly.
BookingSchema.pre("save" as any, async function () {
